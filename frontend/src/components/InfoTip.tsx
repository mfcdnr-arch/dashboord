  ...
  return (
    <span style={{ position: 'relative', display: 'inline-flex' }}
      ...
      <button type="button" aria-label={label} title=""
        ...
        style={{ width: 16, height: 16, borderRadius: '50%', border: '1px solid #c9d3e0', background: '#eef2f8',
          color: '#2f5496', fontSize: 11, lineHeight: '14px', cursor: 'help', padding: 0, fontWeight: 700 }}>i</button>
      {open && (
        <span role="tooltip" style={{
          position: 'absolute', top: '130%', left: '50%', transform: 'translateX(-50%)', zIndex: 70,
          width: 220, background: '#1f2937', color: '#fff', fontSize: 12, lineHeight: 1.4, fontWeight: 400,
