...
export const DEFAULT_SIZE: Record<string, { w: number; h: number }> = {
  ...
  matrix: { w: 12, h: 8 },
  // Светофор и воронка размера не имели вовсе и попадали в запасное 4×4:
  // у воронки в такой ширине не помещается подпись этапа, у светофора
  // плитки схлопываются в один столбец.
...
export const tabActive: React.CSSProperties = { background: 'var(--accent-weak-bg)', border: '1px solid var(--accent)', color: 'var(--accent-text)' }
