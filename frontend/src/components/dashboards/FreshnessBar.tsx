...
export function FreshnessBar(
  ...
  // Тихая строка «🕓 данные на …» живёт в строке контекста шапки дашборда
  // (DashboardHeader) — здесь остаётся только СОБЫТИЕ: появился более свежий
  // выпуск. Пока событий нет, полоса не занимает место вовсе.
