...
const ICONS: Record<string, React.ReactNode> = {
  ...
  spark_table: <svg style={box} viewBox="0 0 52 34"><line x1="5" y1="9" x2="17" y2="9" stroke={C3} strokeWidth="1.5" /><polyline points="21,11 27,7 33,9 39,4" fill="none" stroke={GREEN} strokeWidth="1.5" /><text x="43" y="11" fontSize="6" fill={C1}>12</text><line x1="5" y1="19" x2="17" y2="19" stroke={C3} strokeWidth="1.5" /><polyline points="21,16 27,19 33,17 39,21" fill="none" stroke={C1} strokeWidth="1.5" /><text x="43" y="21" fontSize="6" fill={C1}>7</text><line x1="5" y1="29" x2="17" y2="29" stroke={C3} strokeWidth="1.5" /><polyline points="21,29 27,27 33,30 39,26" fill="none" stroke={GOLD} strokeWidth="1.5" /><text x="43" y="31" fontSize="6" fill={C1}>9</text></svg>,
  field_list: <svg style={box} viewBox="0 0 52 34"><text x="4" y="9" fontSize="5.5" fill={C3}>ЗАГС</text><rect x="4" y="11" width="30" height="4" rx="2" fill={C1} /><text x="37" y="15" fontSize="6" fill={C1}>2,4к</text><rect x="4" y="18" width="20" height="4" rx="2" fill={C3} /><text x="37" y="22" fontSize="6" fill={C3}>1,2к</text><rect x="4" y="25" width="11" height="4" rx="2" fill={GOLD} /><text x="37" y="29" fontSize="6" fill={C3}>717</text></svg>,
...
export const WIDGET_GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { v: 'spark_table', t: 'Строки с мини-графиками', hint: 'Как двигалась каждая строка: линия за последние отчёты, текущее значение и изменение. Матрица отвечает тем же разрезом, но числами и не помещается на десятках столбцов' },
      { v: 'field_list', t: 'Показатели списком', hint: 'Столбцы формы — строками: какие услуги идут и в каком объёме. Единственный вид, который работает внутри одного отделения — все остальные списки строятся по строкам и там схлопываются в одну' },
