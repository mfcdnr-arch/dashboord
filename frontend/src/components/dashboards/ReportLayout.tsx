...
/** Ширина ШИРОКОГО отчёта (PNG). Колонка — те же ~950px, что занимает блок в
 *  обычном отчёте: тогда графики и таблицы выглядят как в PDF и ничего не
 *  надо перевёрстывать. Три колонки дают почти альбомный лист вместо ленты. */
export const REPORT_COLUMNS_WIDE = 3
export const REPORT_WIDTH_WIDE = 48 + REPORT_COLUMNS_WIDE * 950 + (REPORT_COLUMNS_WIDE - 1) * 14
