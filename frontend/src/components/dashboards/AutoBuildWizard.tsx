...
const BLOCK_LABELS: Record<string, string> = {
  ...
  matrix: 'Матрица «строка × дата»',
  compare: 'Сравнение показателей',
  bar: 'График по строкам',
  table: 'Таблица первичных данных',
  // Виды, которые система подбирает под смысл данных: воронка, светофор,
  // тепловая карта, водопад, круговая, год-к-году. Каждый ставится только
