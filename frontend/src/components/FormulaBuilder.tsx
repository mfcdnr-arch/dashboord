...
const tabBtnActive: React.CSSProperties = { background: 'var(--accent-weak-bg)', border: '1px solid var(--accent)', color: 'var(--accent-text)' }
const addBtn: React.CSSProperties = { marginTop: 10, height: 34, padding: '0 14px', border: '1px dashed var(--text-faint)', borderRadius: 8, background: 'var(--surface)', color: 'var(--accent-text)', cursor: 'pointer', fontSize: 13 }
...
const pctLbl: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: 'var(--accent-text)' }
