...
const HINTS: Record<string, Hint> = {
  ...
  uploads: {
    icon: '📥',
    text: 'Общая зона приёма файлов: папку выбирать не нужно — система разберёт файл и по структуре формы положит его туда, куда складывают такие отчёты.',
    managerText: 'Незнакомую форму система не угадывает: файл останется во «Входящих» и подождёт вашего решения. После первого выпуска бланк запоминается, и следующий такой файл разложится сам.',
  },
  map: {
    icon: '🗺️',
    text: 'Отделения МФЦ: где находятся, когда работают и куда звонить. Эти же сведения карта показывает на точке.',
    managerText: 'Новое отделение заводится кнопкой «＋ Отделение» или загрузкой перечня файлом; система сама скажет, если в отчёте появилось отделение, которого нет в справочнике. Закрытое отделение не удаляйте — снимите отметку «действует», тогда история цифр останется связанной.',
  },
  objects: {
    icon: '🗂️',
