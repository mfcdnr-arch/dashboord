...
первичных документов (Excel/CSV/PDF/Word) → распознавание таблиц → выпуск
датасетов → метрики с прозрачными формулами → дашборды с 15 типами виджетов →
модерация публикации → экспорт (Excel/PDF/PNG), архив и витрины.
